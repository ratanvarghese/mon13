...
pub const names_fr_FR_julian = base.NameList{
    .month_list = names_gr.names_fr_FR_gregorian.month_list,
    .weekday_list = names_gr.names_fr_FR_gregorian.weekday_list,
    .era_list = @ptrCast([*:null]?[*:0]u8, &julian_era_list_fr_FR),
    .intercalary_list = names_gr.names_fr_FR_gregorian.intercalary_list,
    .alt_intercalary_list = names_gr.names_fr_FR_gregorian.alt_intercalary_list,
